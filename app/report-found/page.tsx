...
export default function ReportFoundPage() {
  ...
  const [itemStatus, setItemStatus] = useState<"active" | "at_security">("active")
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    router.push("/dashboard?success=found")
  }
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-3xl font-bold mb-2 text-balance">Report Found Item</h1>
            <p className="text-muted-foreground text-pretty">
              Thank you for helping! Fill out the form below to report the item you found so the owner can claim it.
            </p>
          </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Upload a photo to help the owner identify their item</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select name="campus" required>
                    <SelectTrigger>
                      <SelectValue placeholder="Select campus where item was found" />
                    </SelectTrigger>
                    <SelectContent>
                      {campuses.map((campus) => (
                ...
                <div className="space-y-3 border rounded-lg p-4 bg-muted/30">
                  ...
                  <RadioGroup value={itemStatus} onValueChange={(v) => setItemStatus(v as "active" | "at_security")}>
                    <div className="flex items-start space-x-2">
                      <RadioGroupItem value="active" id="hold" />
                      <div className="grid gap-1.5 leading-none">
                        <Label htmlFor="hold" className="font-normal cursor-pointer">
                          I'm holding the item temporarily
                        </Label>
                        <p className="text-sm text-muted-foreground">
                          The owner can contact you directly to arrange pickup
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-2">
                      <RadioGroupItem value="at_security" id="security" />
                      <div className="grid gap-1.5 leading-none">
                        <Label htmlFor="security" className="font-normal cursor-pointer">
                          Handed over to campus security
                        </Label>
                        <p className="text-sm text-muted-foreground">The item is at the campus security office</p>
                      </div>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div className="border-t pt-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    The owner will use this information to contact you about claiming the item.
                  </p>
